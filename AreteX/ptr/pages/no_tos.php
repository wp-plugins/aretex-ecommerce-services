...
$biz_toc_url = get_option('aretex_ptr_tos_link');
...
<form id="agreee_form" action="javascript:void(0);">
<?php  
...
<div class="section group"> <!-- ROW -->
    ...
    <div class="col span_4_of_12"> <!-- Column -->
    <input id="payee_email" readonly="readonly" class="required email" value="<?php echo $payee_email ?>" />
    </div> <!-- END Column -->
</div> <!-- END ROW -->
...
<div class="section group"> <!-- ROW -->
    ...
    <div class="col span_4_of_12"> <!-- Column -->
    <input id="payee_name"   readonly="readonly" value="<?php echo $payee_name ?>" />
    </div> <!-- END Column -->
</div> <!-- END ROW -->
...
<div class="section group"> <!-- ROW -->
    ...
    <div class="col span_4_of_12"> <!-- Column -->
    <textarea id="payee_address"  readonly="readonly"   ><?php echo $atx_payee_address; ?></textarea>
    </div> <!-- END Column -->
</div> <!-- END ROW -->
...
<div class="section group"> <!-- ROW -->
    ...
    <div class="col span_4_of_12"> <!-- Column -->
    <input id="payee_phone"  readonly="readonly" class="required phoneUS" value="<?php echo $atx_payee_phone;?>" />
    </div> <!-- END Column -->
</div> <!-- END ROW -->

<div class="section group"> <!-- ROW -->
    <div class="col span_3_of_12"> <!-- Column -->
    <span style="text-align:right; float:right; font-weight:bold">Agree to Terms to Recieve Payments</span>
    </div> <!-- END Column -->
    <div class="col span_4_of_12"> <!-- Column -->
    <button type="button" style="padding: 3px;" onclick="ajax_payee_agree_tos();" class="ui-button button_link  ui-state-default ui-corner-all"  ><span style="display: inline-block; position: relative; top:3px;" class="ui-icon ui-icon-circle-check"></span>I Agree</button>
    </div> <!-- END Column -->
</div> <!-- END ROW -->
<div class="section group"> <!-- ROW -->
