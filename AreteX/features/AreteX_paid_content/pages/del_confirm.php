...
$title = "Confirm Delete Paid Content Authorization";
...
<div class="section group"> <!-- ROW -->
    ...
    <div class="col span_7_of_12"> <!-- Column -->
        ...
        <input type="text"  name="data[name]" readonly="readonly" id="deliverable_name"  value="<?php echo $deliverable['name'];  ?>" />
    </div> <!-- END Column -->
</div> <!-- END ROW -->
...
<div class="section group"> <!-- ROW -->
    ...
    <div class="col span_2_of_12"> <!-- Column -->
         <input type="text"  name="data[first_delivery]" readonly="readonly" id="first_delivery"  value="<?php echo $deliverable['schedule']['first_delivery'];  ?>" />
    </div> <!-- END Column -->
    <div class="col span_2_of_12"> <!-- Column -->
        <input type="text"  name="data[duration]" readonly="readonly" id="deliverable_duration"  value="<?php echo $deliverable['type_details']['duration'];  ?>" />
    </div> <!-- END Column -->

    <div class="col span_3_of_12"> <!-- Column -->
         
        <input id="delivery_cycle" readonly="readonly" name="data[delivery_cycle]" value="<?php echo $deliverable['schedule']['delivery_cycle'];  ?>" class="required" style="display: inline-block;"/>
...
<p>So if you delete ... here's what happens</p>
</div>
    </div> <!-- END Column -->
</div> <!-- END ROW -->
 <script>
