...
<p style="margin: 5px;">Use the "View" button in the "Details" column to see the details of your authorization,  change the payment card you use, cancel your subscription, or view your rebill payment history.</p>
...
function view_rebill_detail(id)
{
    ...
    load_linked_cam_page('rebill_detail',id);
