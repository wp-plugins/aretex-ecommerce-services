...
<?php if ($detail->rebill_method == 'automatic' && $detail->status == 'active') { 
...
<div class="section group"> <!-- ROW -->
        <div class="col span_4_of_12"> <!-- Column -->
        <span style="text-align:right; float:right; font-weight:bold">Rebill Cancel </span>
    </div> <!-- END Column -->
    <div class="col span_4_of_12"> <!-- Column -->
...
<div class="section group"> <!-- ROW -->
    ...
    <div class="col span_8_of_12"> <!-- Column -->
    <button type="button" class="icon_left_button_bg ui-button button_link ui-state-default ui-corner-all" onclick="load_linked_cam_page('reports/cam/rebill_payments','<?php echo $_REQUEST['linked_id'] ?>');" >
    ...
    <div class="col span_4_of_12"> <!-- Column -->
        ...
        <p>Use this screen to manage or view your customer's rebill agreement.</p> 
           <p>You can see the details of the authorization, cancel the subscription, and view the rebill payment history.</p>
        </div>
